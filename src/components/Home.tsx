...
export function Home() {
  ...
  return (
    ...
    >
      <Card className="w-full max-w-lg p-8 flex flex-col items-center justify-center space-y-8 bg-neutral-900/50 backdrop-blur-xl border-neutral-800 shadow-2xl rounded-3xl">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-6xl font-bold text-neutral-100">Immortalisez votre aventure !</h1>
          <p className="text-neutral-400 text-3xl">Photographiez-vous devant le portail qui mène au monde des jeux.</p>
        </div>

        <button
          onClick={handleStart}
          className="w-full py-4 px-6 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-semibold text-3xl transition-all active:scale-95 shadow-lg shadow-emerald-500/25 border-none"
        >
          Commencer
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2 text-xl text-neutral-500 hover:text-neutral-300 transition-colors border-none bg-transparent cursor-pointer"
        >
      ...
      <Dialog open={showAuthDialog} onOpenChange={setShowAuthDialog}>
        <DialogContent className="bg-neutral-900 border-neutral-800 text-neutral-100 rounded-2xl max-w-md">
          <DialogHeader className="space-y-3">
            ...
            <DialogTitle className="text-center text-4xl font-bold text-neutral-100">
              Portail d'Administration
            </DialogTitle>
            <DialogDescription className="text-center text-2xl text-neutral-400">
          ...
          <form onSubmit={handleLogin} className="space-y-4 pt-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="text-xl bg-neutral-950/50 border-neutral-800 text-neutral-200 placeholder:text-neutral-600 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 h-14 rounded-xl"
                autoFocus
              />
            ...
            <Button
              ...
              className="text-xl w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold h-11 rounded-xl transition-all shadow-lg shadow-emerald-500/15 flex items-center justify-center gap-2"
            >
              {isAuthenticating ? (
                <>
